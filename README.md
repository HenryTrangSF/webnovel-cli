...
Simply run `npm install` to install all the relevant packages required to run webnovel-cli. Npm will do the hard work. Login to the Ghost admin console and go to Inegrations and create a new integration. 

Copy and paste the API URL and Admin API Key into the `.env` file.
